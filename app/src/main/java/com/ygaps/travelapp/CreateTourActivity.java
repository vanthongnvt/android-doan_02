    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Number numAdults = Long.parseLong(strAdult);
                Number numChilds = Long.parseLong(strChild);
                Number numMinCost = Long.parseLong(strMinCost);
                Number numMaxCost = Long.parseLong(strMaxCost);
